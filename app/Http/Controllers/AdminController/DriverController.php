...
class DriverController extends Controller
{
    ...
    {
        return view('Backend.Driver.driver_listing');
    }
    ...
    public function listing(Request $request)
    {
        ...
        $sql = "SELECT * FROM users WHERE users.status=1 AND users.role_id = 3 $filter $where";
        ...
        foreach ($result as $obj) {
            $id = $obj->id;
            $actionButtons = '
            <a class="btn btn-sm btn-info" href="' . route('driver.view', $id) . '" title="View">
                    <i class="fas fa-eye"></i>
            </a>
            <a class="btn btn-sm btn-warning" href="' . route('driver.edit', $id) . '" title="Edit">
                <i class="fas fa-edit"></i>
            </a>
            <a class="btn btn-sm btn-danger" href="' . route('driver.delete', $id) . '" title="Delete" onclick="return confirm(\'Are you sure you want to delete this item?\');">
    ...
    public function add(Request $request)
    {
        if($request->all())
        {
            ...
            if (!$validator->fails()) {
                ...
                session()->flash('success', 'Driver Registered Successfull');
        ...
        return view('Backend.Driver.driver_add')->with(['role'=>$role]);
    ...
    public function view($id)
    {
        ...
        return view('Backend.Driver.driver_view')->with(['data'=>$data]);
    }
    ...
    public function edit(Request $request)
    {
        ...
        return view('Backend.Driver.driver_edit')->with(['data'=>$data,'role'=>$role]);
    }
    ...
    public function delete($id)
    {
        ...
        $user->status=0;
        $user->save();
        session()->flash('delete', 'Driver Deleted Successfully');
        return redirect()->route('driver.index');
    }
