                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <div class="tab-content">
                                    ...
                                    @endif
                                        <h1 class="mb-3">Edit Driver Task</h1>
                                        <form action="{{ Route('admin_driver_task.update',$driver_task->id) }}" method="POST">
                                            @csrf
                                            <div class="row">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="controls">
                                                            ...
                                                            <select class="form-control" name="order" id="">
                                                                ...
                                                                <option value="{{$order->id }}"{{$order->id==$driver_task->order_id ? 'selected':''}}>
                                                                    {{ $order->order_no }}
                                                                </option>
                                                                @endforeach
                                                            </select>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="controls">
                                                            ...
                                                            <select class="form-control" name="driver" id="">
                                                                ...
                                                                <option value="{{$user->id}}"{{$user->id==$driver_task->driver_id ? 'selected':''}}>{{$user->name}}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                    </div>
