        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2">
                    <h3 class="content-header-title">Driver List</h3>
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">All Driver
                                </li>
                            </ol>
                        </div>
                    </div>
...
@section('page-js')
    <script>
        ...
        function loadData() {
            ...
            $("#button-container").html('<a href="{{ route('driver.add') }}" id="custom-button" class="btn btn-primary mb-2">Add New +</a>');
        }
        loadData();
    </script>
@endsection
