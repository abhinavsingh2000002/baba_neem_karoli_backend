                    ...
                    <div class="users-list-filter px-1">
                        <form>
                            <div class="row border border-light rounded py-2 mb-2">
                                ...
                                <div class="col-12 col-sm-6 col-lg-3 d-flex align-items-center">
                                    <button id="excel_download" class="btn btn-block btn-danger glow">Excel
                                        Download</button>
                                </div>
                            </div>
                        </form>
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.failed == 'No Order Found !') {
                            ...
                            window.location.href = "{{ Route('admin_order_report.reportpdf') }}" + "?date=" +
                                date;
                        }
                    },
                    error: function(xhr, status, error) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.failed == 'No Order Found !') {
                            ...
                            window.location.href = "{{ Route('admin_order_report.reportExcel') }}" + "?date=" +
                                date;
                        }
                    },
                    error: function(xhr, status, error) {
