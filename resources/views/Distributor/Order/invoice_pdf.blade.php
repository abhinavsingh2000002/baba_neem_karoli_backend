...
<body>
    <div class="invoice-container">
        ...
        <div class="company-details">
            ...
            <h2>Modern Creative Studio</h2>
            <p>4025 Oak Avenue, Melbourne, Florida 32940, USA</p>
        </div>

        <div class="invoice-details">
            <h3>Invoice Details</h3>
            <p>Invoice No: <strong>1403520059</strong></p>
            <p>Date: <strong>2024-10-15</strong></p>
            <p>Time: <strong>03:24:37</strong></p>
        </div>
        ...
        <div class="total">
            <h3>Total Amount</h3>
            <p>Sub Total: <strong><i class="fa-solid fa-indian-rupee-sign"></i>{{$orderDetail[0]->total_amount}}</strong></p>
            <p>TAX (12%): <strong>0</strong></p>
            <p>Total: <strong><i class="fa-solid fa-indian-rupee-sign"></i>{{$orderDetail[0]->total_amount}}</strong></p>
        </div>
