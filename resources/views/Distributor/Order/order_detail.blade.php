                ...
                <div id="invoice-template" class="card-body p-4">
                    ...
                    <div id="invoice-company-details" class="row">
                        ...
                        <div class="col-sm-6 col-12 text-center text-sm-right">
                            <h2>INVOICE</h2>
                            <p class="pb-sm-3">{{$orderDetail[0]->bill_no}}</p>
                            <ul class="px-0 list-unstyled">
                                <li>Total Bill Amount</li>
                                <li class="lead text-bold-800"><i class="fa-solid fa-indian-rupee-sign"></i>{{$orderDetail[0]->total_amount}}</li>
                            </ul>
                        </div>
                    </div>
                    <!-- Invoice Company Details -->
                    ...
                    <div id="invoice-customer-details" class="row pt-2">
                        ...
                        <div class="col-sm-6 col-12 text-center text-sm-right">
                            <p><span class="text-muted">Invoice Date :</span> {{$orderDetail[0]->order_date}}</p>
                            <p><span class="text-muted">Invoice Time :</span> {{$orderDetail[0]->order_time}}</p>
                                ...
                                <div class="table-responsive">
                                    <table class="table">
                                        <tbody>
                                            <tr>
                                                <td>Sub Total</td>
                                                <td class="text-right">{{$orderDetail[0]->total_amount}}</td>
                                            </tr>
                                            <tr>
                                                <td>TAX (12%)</td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-bold-800 text-right">{{$orderDetail[0]->total_amount}}</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-5 col-12 text-center">
                                <button type="button" class="btn btn-info btn-print btn-lg my-1"><i class="la la-paper-plane-o mr-50"></i>
                                    Print
                                    Invoice</button>
                                <a href="{{Route('order.invoicePdf',$orderDetail[0]->order_id)}}" class="btn btn-info  btn-lg my-1" style="color: white;">
